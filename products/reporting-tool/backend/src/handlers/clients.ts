 ...
 */
export async function handleCreateClient(c: Context<{ Bindings: Env }>): Promise<Response> {
 ...
 */
export async function handleListClients(c: Context<{ Bindings: Env }>): Promise<Response> {
  const storage = new Storage(c.env.REPORTING_KV, c.env.REPORTING_R2);
 ...
 * Delete a client
 */
export async function handleDeleteClient(c: Context<{ Bindings: Env }>): Promise<Response> {
  const storage = new Storage(c.env.REPORTING_KV, c.env.REPORTING_R2);
