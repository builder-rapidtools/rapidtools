 ...
 */
export async function handleRegisterAgency(c: Context<{ Bindings: Env }>): Promise<Response> {
 ...
 */
export async function handleGetAgency(c: Context<{ Bindings: Env }>): Promise<Response> {
  try {
